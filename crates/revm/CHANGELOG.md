...
## [9.1.0](https://github.com/anonymousGiga/revm/compare/revm-v9.0.0...revm-v9.1.0) - 2024-05-31

### Added
- *(optimism)* Implement new L1 cost function for Fjord ([#1420](https://github.com/anonymousGiga/revm/pull/1420))
- *(optimism)* Add secp256r1 precompile for Fjord ([#1436](https://github.com/anonymousGiga/revm/pull/1436))
- *(revm)* revert EIP-2935 BLOCKHASH opcode changes ([#1450](https://github.com/anonymousGiga/revm/pull/1450))
- load account should return db error ([#1447](https://github.com/anonymousGiga/revm/pull/1447))
...
### Other
- *(primitives)* rename State/Storage to EvmState/EvmStorage ([#1459](https://github.com/anonymousGiga/revm/pull/1459))
- remove 'checked' bytecode bench causing benchmarks to crash due to name ([#1461](https://github.com/anonymousGiga/revm/pull/1461))
- cargo update ([#1451](https://github.com/anonymousGiga/revm/pull/1451))
- cleanup host blockhash fn ([#1430](https://github.com/anonymousGiga/revm/pull/1430))
...
- *(deps)* bump anyhow from 1.0.82 to 1.0.83 ([#1404](https://github.com/anonymousGiga/revm/pull/1404))
